  ...
  <div class="card border-secondary mb-3 card-form">
    ...
    <div class="card-body">
      <form action="loginParse" method="post">
          <label for="username">Username</label><input class="form-control" id="username" type="text" name="username" placeholder="Enter your username" required autocomplete="off"/><br/>
